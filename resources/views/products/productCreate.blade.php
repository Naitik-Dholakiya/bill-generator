...
@section('content')
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="lf_product_code"
                                        value="{{ $productCode ?? 'Auto Generated' }}" readonly
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tb_product_name" value="{{ old('tb_product_name') }}"
                                        required
                                ...
                                <div>
                                    ...
                                    <select name="dd_supplier" required
                                        class="w-full px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <select name="dd_category" id="categoryDropdown" required
                                ...
                                <div class="md:col-span-2">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="0.01" name="tb_purchase_price"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="0.01" name="tb_selling_price"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="tb_reorder_level"
    ...
    <div id="categoryModal" class="fixed inset-0 bg-black/50 hidden z-50 flex items-center justify-center p-4">
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-md">
            ...
            <form action="{{ route('category.store.ajax') }}" method="POST" id="categoryForm">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="4" class="w-full px-4 py-3 rounded-xl border dark:bg-zinc-800"></textarea>

                    </div>

                    <div class="flex justify-end gap-2">

                        <button type="button" onclick="closeCategoryModal()" class="px-5 py-2 rounded-xl border">

                            Cancel

                        </button>

                        <button class="px-5 py-2 rounded-xl bg-cyan-600 text-white">
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        Swal.fire({
                            ...
                            position: 'top',
                            icon: 'error',
                            title: data.message || 'Unable to save category.',
                            showConfirmButton: false,
                            timer: 3500,
                            timerProgressBar: true,
                            background: 'rgba(17,24,39,0.85)',
