...
@section('content')
    ...
    <div class="flex h-screen overflow-hidden bg-gray-50 dark:bg-zinc-950">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            @include('layout.navbar', ['title' => 'Add Customer'])
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Create a new customer for billing and invoicing.
                    </p>
                </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="customer_code" value="{{ $customerCode ?? 'Auto Generated' }}" readonly class="w-full px-4 py-3 rounded-xl
                ...
                outline-none">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-3 rounded-xl
                bg-white dark:bg-zinc-800
                border border-gray-200 dark:border-zinc-700
                focus:ring-2 focus:ring-cyan-500
                outline-none">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone" value="{{ old('phone') }}" class="w-full px-4 py-3 rounded-xl
                bg-white dark:bg-zinc-800
                border border-gray-200 dark:border-zinc-700
                focus:ring-2 focus:ring-cyan-500
                outline-none">
                            ...
                            <div class="mt-6">
                                ...
                                <input type="text" name="gst_number" value="{{ old('gst_number') }}" class="w-full px-4 py-3 rounded-xl
            bg-white dark:bg-zinc-800
            border border-gray-200 dark:border-zinc-700
            focus:ring-2 focus:ring-cyan-500
            outline-none">
                            ...
                            border border-gray-200 dark:border-zinc-700
                            focus:ring-2 focus:ring-cyan-500
                            outline-none">{{ old('billing_address') }}</textarea>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-2">
                                    ...
                                    <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                                        ...
                                        <input type="checkbox" id="sameAsBilling" class="w-4 h-4 rounded border-gray-300
                        ...
                        border border-gray-200 dark:border-zinc-700
                        focus:ring-2 focus:ring-cyan-500
                        outline-none">{{ old('shipping_address') }}</textarea>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function syncShippingAddress() {
                    ...
                    if (sameAsBilling.checked) {
                        ...
                        shippingAddress.classList.remove(
                            'bg-gray-100',
                            'dark:bg-zinc-700',
                            'cursor-not-allowed'
                        );
